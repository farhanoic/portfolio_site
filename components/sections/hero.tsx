        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {['TypeScript', 'JavaScript', 'Python', 'HTML', 'CSS', 'SQL', 'Next.js', 'React', 'Tailwind CSS', 'Node.js', 'shadcn/ui', 'Radix UI', 'Framer Motion', 'Recharts', 'ESLint', 'Prettier', 'Webpack', 'TanStack React Query', 'React Hook Form', 'PostgreSQL', 'Supabase', 'Redis', 'Google APIs', 'Vercel Analytics', 'Vercel', 'TypeScript', 'JavaScript', 'Python', 'HTML', 'CSS', 'SQL', 'Next.js', 'React', 'Tailwind CSS', 'Node.js', 'shadcn/ui', 'Radix UI', 'Framer Motion', 'Recharts', 'ESLint', 'Prettier', 'Webpack', 'TanStack React Query', 'React Hook Form', 'PostgreSQL', 'Supabase', 'Redis', 'Google APIs', 'Vercel Analytics', 'Vercel', 'TypeScript', 'JavaScript', 'Python', 'HTML', 'CSS', 'SQL', 'Next.js', 'React', 'Tailwind CSS', 'Node.js', 'shadcn/ui', 'Radix UI', 'Framer Motion', 'Recharts', 'ESLint', 'Prettier', 'Webpack', 'TanStack React Query', 'React Hook Form', 'PostgreSQL', 'Supabase', 'Redis', 'Google APIs', 'Vercel Analytics', 'Vercel'].map((skill, index) => (
                  <div
                    key={index}
